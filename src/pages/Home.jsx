...
// TODO: reemplazar con las cuentas reales de Bio Emplast
const redes = [
...
export default function Home() {
  return (
    <>
      {/* HERO con foto de fondo y overlay verde */}
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        <img
          src="/productos/rollos--57.jpg"
          alt=""
          aria-hidden="true"
        ...
        <div className="site-container relative py-24 text-white">
          <AnimatedSection className="max-w-2xl">
            <p className="text-xs font-bold uppercase tracking-[.14em] text-brand-yellow">
              Empaque industrial · Colombia
            </p>
            <h1 className="mt-6 text-4xl font-extrabold leading-[1.05] sm:text-5xl lg:text-6xl">
              Expertos en <span className="text-brand-green">empaque industrial</span> con
              enfoque ecológico
            </h1>
            <p className="mt-6 max-w-xl text-lg leading-8 text-white/85">
              Producimos stretch film, bolsas especializadas, vinipel y servicios de precorte
              con trazabilidad. Protegemos tu producto y cuidamos el planeta.
            </p>
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              <Button asChild variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-brand-ink">
      ...
      <AnimatedSection className="site-container py-20 lg:py-28">
        ...
        <div className="mt-3 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <h2 className="text-3xl font-extrabold sm:text-4xl">
            Especialistas en soluciones de empaque
          </h2>
          <p className="max-w-sm text-sm text-muted-foreground">
            Explora algunas de nuestras líneas más solicitadas.
          </p>
        </div>
        <div className="mt-10">
          <ProductCarousel />
      ...
      {/* NOSOTROS (preview con estadísticas) */}
      <AnimatedSection className="site-container grid gap-12 py-20 lg:grid-cols-2 lg:items-center lg:py-28">
        <div>
          ...
          <h2 className="mt-3 text-3xl font-extrabold sm:text-4xl">
            Comprometidos con un empaque más responsable
          </h2>
          <p className="mt-5 max-w-lg text-muted-foreground leading-7">
            ...
            que protejas tu producto sin perder de vista el impacto ambiental de tu operación.
          </p>
          ...
          <Link
            to="/nosotros"
            className="mt-8 inline-flex items-center gap-2 font-bold text-brand-green-dark hover:text-brand-green"
          >
        ...
        <div className="relative">
          <div className="card-shadow overflow-hidden">
            <img
              src="/productos/empaque-vacio-2.jpg"
              alt="Empaque al vacío Bio Emplast"
      ...
      <section className="bg-secondary/60 py-20 lg:py-28">
        <AnimatedSection className="site-container text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Novedades de producto, tips de empaque y lo que hacemos día a día en planta.
          </p>
          <div className="mt-12 grid gap-6 sm:grid-cols-2 max-w-xl mx-auto">
            {redes.map((r, i) => (
              <AnimatedSection
                ...
                as="a"
                delay={i * 0.1}
                className={`social-card bg-gradient-to-br ${r.gradiente}`}
              >
                <a href={r.url} target="_blank" rel="noreferrer" className="block">
                  ...
                  <span className="mt-4 inline-block rounded-full bg-white/20 px-4 py-1.5 text-sm font-bold">
                    Seguir →
                  </span>
                </a>
              </AnimatedSection>
      ...
      <AnimatedSection className="site-container py-20 lg:py-28">
        <div className="card-shadow flex flex-col items-start gap-6 bg-brand-green-dark p-10 text-white sm:flex-row sm:items-center sm:justify-between lg:p-14">
          <h2 className="max-w-lg text-2xl font-extrabold sm:text-3xl">
            ¿Listo para tu próximo pedido de empaque?
          </h2>
          <Button asChild variant="whatsapp" size="lg">
            <a href={whatsappUrl} target="_blank" rel="noreferrer">
              <MessageCircle /> Escríbenos ahora
            </a>
          </Button>
        </div>
      </AnimatedSection>
